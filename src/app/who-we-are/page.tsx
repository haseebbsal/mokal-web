...
export const metadata: Metadata = {
  ...
  description: "MGC Freight is an Ontario-based freight platform and 3PL provider connecting shippers with a network of 160,000+ carriers across North America.",
