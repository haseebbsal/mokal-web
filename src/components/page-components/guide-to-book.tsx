    ...
    return (
        <div className="bg-white w-full">
            <div className={`flex flex-col m-auto sm:px-8 px-4 sm:py-20 py-16 sm:w-[80%] text-center gap-20`}>
                <div>
                    <h1 className="font-bold sm:text-[2.3rem] text-[1.5rem]">A Quick Guide To Book A <LinearGradientText text={{ en: "shipment", fr: "expédition" }} /> On Our App </h1>
                    <h1 className="font-bold sm:text-[2.3rem] text-[1.5rem]">Follow The Steps To Place Your <LinearGradientText text={{ en: "shipment", fr: "expédition" }} /> </h1>
                </div>
                ...
                <div className="flex flex-col gap-16">
                    <div className={`flex sm:flex-row flex-col   items-center text-center gap-16`}>
                        ...
                        <div className="flex sm:order-1 order-0 flex-1 flex-col sm:items-start items-center sm:text-start text-center gap-4">
                            ...
                            <h1 className="sm:text-[2rem] text-[1.5rem] font-bold">Get a <LinearGradientText extraClass="" text={{ en: "Quick Quote", fr: "Soumission rapide" }} /> </h1>
                    ...
                    <div className={`flex sm:flex-row flex-col   items-center text-center gap-16`}>
                        <div className="flex flex-1 flex-col sm:items-start items-center sm:text-start text-center gap-4">
                            ...
                            <h1 className="sm:text-[2rem] text-[1.5rem] font-bold">Provide <LinearGradientText extraClass="" text={{ en: "Shipment Details", fr: "Détails de l'expédition" }} /> </h1>
                    ...
                    <div className={`flex  flex-col   items-center text-center gap-4`}>
                        <div className="flex flex-col gap-1">
                            ...
                            <h1 className="sm:text-[2rem] text-[1.5rem] font-bold"><LinearGradientText extraClass="" text={{ en: "Compare and Choose ", fr: "Comparer et choisir " }} /> the Best Carrier </h1>
                    ...
                    <div className={`flex sm:flex-row flex-col   items-center text-center gap-16`}>
                        <div className="flex flex-1 flex-col sm:items-start items-center sm:text-start text-center gap-4">
                            <h1 className="text-base-purple text-2xl">Step # 04</h1>
                            <h1 className="sm:text-[2rem] text-[1.5rem] font-bold">Complete <LinearGradientText extraClass="" text={{ en: "Address and Additional ", fr: "Adresse et renseignements supplémentaires " }} /> Info </h1>
                    ...
                    <div className={`flex sm:flex-row flex-col   items-center text-center gap-16`}>
                        ...
                        <div className="flex flex-1 sm:order-1 order-0  flex-col sm:items-start items-center sm:text-start text-center gap-4">
                            ...
                            <h1 className="sm:text-[2rem] text-[1.5rem] font-bold">Make the Payment and <LinearGradientText extraClass="" text={{ en: "Confirm Order", fr: "Confirmer la commande " }} /> </h1>
